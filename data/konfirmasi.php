...
echo '
  <!-- begin col-6 -->
				...
				$r=mysql_query("select * from transaksi left outer join jadwal on transaksi.Id_Jadwal=jadwal.Id_Jadwal left outer join rute on jadwal.Id_Rute=rute.Id_Rute
								...
								left outer join user on transaksi.Id_User=user.Id_User where transaksi.Status_Pesanan='K' GROUP BY transaksi.Id_Tr");
				while($w=mysql_fetch_array($r)){
					...
					echo"
						...
						<tr>
							...
							<td>$o[j]</td>
							<td>
								<a href='?menu=konfirmasi-cek&cek&kd=$w[Id_Tr]'> <i class='fa fa-edit'></i> </a>
							</td>
						</tr>";
				}
