  ...
  <!-- begin col-6 -->
                ...
                <div class="panel panel-inverse" data-sortable-id="form-stuff-3" data-init="true">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Laporan Pemberangkatan</h4>
                        </div>
				...
				$r=mysql_query("select * from transaksi left outer join jadwal on transaksi.Id_Jadwal=jadwal.Id_Jadwal left outer join rute on jadwal.Id_Rute=rute.Id_Rute
								...
								left outer join user on transaksi.Id_User=user.Id_User where transaksi.Status_Pesanan='L' and bus.Id_Bus='$_SESSION[IDBUS]' and Tanggal_Pemesanan=curdate() GROUP BY transaksi.Id_Tr");
